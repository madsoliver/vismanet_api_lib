# Ekstralys\VismaNetApi\SalesCategoryApi

All URIs are relative to *https://localhost/API*

Method | HTTP request | Description
------------- | ------------- | -------------
[**salesCategoryGet**](SalesCategoryApi.md#salesCategoryGet) | **GET** /controller/api/v1/salescategory | Get Sales Categories - ScreenId&#x3D;IN204060
...
# **salesCategoryGet**
> \Ekstralys\VismaNetApi\Model\SalesCategoryDto[] salesCategoryGet()
...
$apiInstance = new Ekstralys\VismaNetApi\Api\SalesCategoryApi(
...
try {
    $result = $apiInstance->salesCategoryGet();
    print_r($result);
} catch (Exception $e) {
...
[**\Ekstralys\VismaNetApi\Model\SalesCategoryDto[]**](../Model/SalesCategoryDto.md)
...
> \Ekstralys\VismaNetApi\Model\SalesCategoryDto salesCategoryGetCategoryBycategoryId($category_id)
...
try {
    $result = $apiInstance->salesCategoryGetCategoryBycategoryId($category_id);
    print_r($result);
} catch (Exception $e) {
...
> \Ekstralys\VismaNetApi\Model\InventoryDto[] salesCategoryGetItemsForCategoryBycategoryId($category_id)
...
try {
    $result = $apiInstance->salesCategoryGetItemsForCategoryBycategoryId($category_id);
    print_r($result);
} catch (Exception $e) {
