# Ekstralys\VismaNetApi\CustomerOverdueChargeApi
...
[**customerOverdueChargeGetAll**](CustomerOverdueChargeApi.md#customerOverdueChargeGetAll) | **GET** /controller/api/v1/customerOverdueCharge | Get a range of Customer Overdue Charges - ScreenId&#x3D;AR301000  Request page size must be lower or equal to the allowed max page size which is returned as part of the metadata information.  If requested page size is greater than allowed max page size, request will be limited to max page size
...
> object customerOverdueChargeCreateHeaderAttachmentByoverdueChargeNumber($overdue_charge_number)
...
$apiInstance = new Ekstralys\VismaNetApi\Api\CustomerOverdueChargeApi(
...
try {
    $result = $apiInstance->customerOverdueChargeCreateHeaderAttachmentByoverdueChargeNumber($overdue_charge_number);
    print_r($result);
} catch (Exception $e) {
...
# **customerOverdueChargeCreateLineAttachmentByoverdueChargeNumberlineNumber**
> object customerOverdueChargeCreateLineAttachmentByoverdueChargeNumberlineNumber($overdue_charge_number, $line_number)
...
try {
    $result = $apiInstance->customerOverdueChargeCreateLineAttachmentByoverdueChargeNumberlineNumber($overdue_charge_number, $line_number);
    print_r($result);
} catch (Exception $e) {
...
# **customerOverdueChargeGetAll**
> \Ekstralys\VismaNetApi\Model\CustomerOverdueChargeDto[] customerOverdueChargeGetAll($document_type, $released, $dunning_level, $closed_financial_period, $dunning_letter_date_time, $dunning_letter_date_time_condition, $project, $expand_applications, $expand_dunning_information, $expand_attachments, $expand_tax_details, $expand_invoice_address, $financial_period, $document_due_date, $status, $number_to_read, $skip_records, $external_reference, $payment_reference, $customer_ref_number, $greater_than_value, $last_modified_date_time, $last_modified_date_time_condition, $created_date_time, $created_date_time_condition, $page_number, $page_size)
...
[**\Ekstralys\VismaNetApi\Model\CustomerOverdueChargeDto[]**](../Model/CustomerOverdueChargeDto.md)
...
> \Ekstralys\VismaNetApi\Model\CustomerOverdueChargeDto customerOverdueChargeGetByoverdueChargeNumber($overdue_charge_number)
...
try {
    $result = $apiInstance->customerOverdueChargeGetByoverdueChargeNumber($overdue_charge_number);
    print_r($result);
} catch (Exception $e) {
...
> \Ekstralys\VismaNetApi\Model\ReleaseCustomerOverdueChargeActionResultDto customerOverdueChargeReleaseDocumentByoverdueChargeNumber($overdue_charge_number)
...
try {
    $result = $apiInstance->customerOverdueChargeReleaseDocumentByoverdueChargeNumber($overdue_charge_number);
    print_r($result);
} catch (Exception $e) {
...
[**\Ekstralys\VismaNetApi\Model\ReleaseCustomerOverdueChargeActionResultDto**](../Model/ReleaseCustomerOverdueChargeActionResultDto.md)
...
> object customerOverdueChargeUpdateByoverdueChargeNumber($overdue_charge_number, $overdue_charge)
...
$overdue_charge = new \Ekstralys\VismaNetApi\Model\CustomerOverdueChargeUpdateDto(); // \Ekstralys\VismaNetApi\Model\CustomerOverdueChargeUpdateDto | Defines the data for the Overdue Charge to update

try {
    $result = $apiInstance->customerOverdueChargeUpdateByoverdueChargeNumber($overdue_charge_number, $overdue_charge);
    print_r($result);
} catch (Exception $e) {
 ...
 **overdue_charge** | [**\Ekstralys\VismaNetApi\Model\CustomerOverdueChargeUpdateDto**](../Model/CustomerOverdueChargeUpdateDto.md)| Defines the data for the Overdue Charge to update |
