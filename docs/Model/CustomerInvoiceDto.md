...
**cash_discount_date** | [**\DateTime**](\DateTime.md) | Mandatory field: The top part &amp;gt; Cash discount date * &amp;gt; The end date of the cash discount period, which the system calculates by using the credit terms. | [optional] 
...
**dunning_letter_date** | [**\DateTime**](\DateTime.md) | The Financial details tab &amp;gt; The dunning info section &amp;gt; Dunning letter date &amp;gt; The date of the last released dunning letter in which the document was listed. | [optional] 
...
**invoice_lines** | [**\Ekstralys\VismaNetApi\Model\CustomerInvoiceLineDto[]**](CustomerInvoiceLineDto.md) | Documents details tab | [optional] 
