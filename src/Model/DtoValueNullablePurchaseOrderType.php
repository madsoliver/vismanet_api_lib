...
/**
 * DtoValueNullablePurchaseOrderType Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DtoValueNullablePurchaseOrderType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DtoValue[Nullable[PurchaseOrderType]]';
    ...
    const VALUE_REGULAR_ORDER = 'RegularOrder';
    const VALUE_DROP_SHIP = 'DropShip';
    const VALUE_BLANKET = 'Blanket';
    const VALUE_STANDARD_BLANKET = 'StandardBlanket';
    ...
    {
        return [
            self::VALUE_REGULAR_ORDER,
            self::VALUE_DROP_SHIP,
            self::VALUE_BLANKET,
            self::VALUE_STANDARD_BLANKET,
        ];
    }
