...
/**
 * DtoValueEmployeeTitles Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DtoValueEmployeeTitles implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DtoValue[EmployeeTitles]';
    ...
    const VALUE_DOCTOR = 'Doctor';
    const VALUE_MISS = 'Miss';
    const VALUE_MR = 'Mr';
    const VALUE_MRS = 'Mrs';
    const VALUE_MS = 'Ms';
    const VALUE_PROF = 'Prof';
