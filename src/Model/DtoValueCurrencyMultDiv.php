...
/**
 * DtoValueCurrencyMultDiv Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DtoValueCurrencyMultDiv implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DtoValue[CurrencyMultDiv]';
    ...
    const VALUE_MULTIPLY = 'Multiply';
    const VALUE_DIVIDE = 'Divide';
