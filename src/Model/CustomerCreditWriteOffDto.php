...
/**
 * CustomerCreditWriteOffDto Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomerCreditWriteOffDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomerCreditWriteOffDto';
     ...
     * Sets hold
     *
     * @param bool $hold The top part &gt; Hold &gt; A check box that indicates if the document is a draft. A document with the On Hold status may be edited and cannot be released.
     *
     * @return $this
     */
     ...
     *
     * @param object $customer_vat_zone The Financial details tab &gt; The VAT info section &gt; Customer VAT zone &gt; If the invoice was created from an opportunity that has a VAT zone specified, the VAT zone specified for the opportunity.
     *
     * @return $this
     */
