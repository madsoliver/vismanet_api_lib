...
/**
 * DtoValueSupplierChargeBearer Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DtoValueSupplierChargeBearer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DtoValue[SupplierChargeBearer]';
    ...
    const VALUE_BENEFICIARY = 'Beneficiary';
    const VALUE_SHARED = 'Shared';
    const VALUE_SERVICE_LEVEL = 'ServiceLevel';
    ...
    public function getValueAllowableValues()
    {
        return [
            self::VALUE_PAYER,
            self::VALUE_BENEFICIARY,
            self::VALUE_SHARED,
            self::VALUE_SERVICE_LEVEL,
        ];
    }
