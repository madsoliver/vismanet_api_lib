...
/**
 * DtoValueAccountTypes Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DtoValueAccountTypes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DtoValue[AccountTypes]';
    ...
    const VALUE_LIABILITY = 'Liability';
    const VALUE_INCOME = 'Income';
    const VALUE_EXPENSE = 'Expense';
