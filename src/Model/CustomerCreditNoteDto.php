...
/**
 * CustomerCreditNoteDto Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomerCreditNoteDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomerCreditNoteDto';
    ...
    protected static $swaggerTypes = [
        ...
        'lines' => '\Ekstralys\VismaNetApi\Model\CustomerCreditNoteLineDto[]',
     ...
     * Sets credit_terms
     *
     * @param object $credit_terms The top part &gt; Terms* &gt; The credit terms used in relations with the customer.
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $document_due_date The top part &gt; Due date* &gt; The date when payment for the document is due, in accordance with the credit terms.
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $cash_discount_date The top part &gt; Cash discount date* &gt; The end date of the cash discount period, which the system calculates by using the credit terms.
     *
     * @return $this
     */
     ...
     * Sets exchange_rate
     *
     * @param double $exchange_rate The top part &gt; Currency &gt; The middle field, click the down arrow &gt; Exchange rate - To change the currency rate, click the arrow by the rate to invoke the Rate selection dialog box.
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $dunning_letter_date The Financial details tab &gt; The Dunning information section &gt; Dunning letter date &gt; The date of the last released dunning letter in which the document was listed.
     *
     * @return $this
     */
     ...
     *
     * @param int $dunning_letter_level The Financial details tab &gt; The Dunning information section &gt; Dunning level &gt; The dunning level of the document.
     *
     * @return $this
     */
     ...
     * Sets tax_details
     *
     * @param \Ekstralys\VismaNetApi\Model\TaxDetailDto[] $tax_details tax_details
     *
     * @return $this
     */
     ...
     * Gets lines
     *
     * @return \Ekstralys\VismaNetApi\Model\CustomerCreditNoteLineDto[]
     */
     ...
     * Sets lines
     *
     * @param \Ekstralys\VismaNetApi\Model\CustomerCreditNoteLineDto[] $lines lines
     *
     * @return $this
     */
     ...
     *
     * @param object $customer_vat_zone The Financial details tab &gt; The VAT info section &gt; Customer VAT zone
     *
     * @return $this
     */
