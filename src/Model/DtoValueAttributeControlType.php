...
/**
 * DtoValueAttributeControlType Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DtoValueAttributeControlType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DtoValue[AttributeControlType]';
    ...
    const VALUE_MULTI_SELECT_COMBO = 'MultiSelectCombo';
    const VALUE_LOOKUP = 'Lookup';
