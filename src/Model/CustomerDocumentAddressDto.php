...
/**
 * CustomerDocumentAddressDto Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomerDocumentAddressDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomerDocumentAddressDto';
     ...
     * Sets address_line1
     *
     * @param string $address_line1 Address 1 &gt; The first line of the customer's contact address.
     *
     * @return $this
     */
     ...
     *
     * @param bool $override_address Override address &gt; A check box that indicates (if selected) that the invoice address is not the default invoice address of the customer.
     *
     * @return $this
     */
