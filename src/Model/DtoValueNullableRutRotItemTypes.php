...
/**
 * DtoValueNullableRutRotItemTypes Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DtoValueNullableRutRotItemTypes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DtoValue[Nullable[RutRotItemTypes]]';
    ...
    const VALUE_MATERIAL_COST = 'MaterialCost';
    const VALUE_OTHER_COST = 'OtherCost';
    ...
    public function getValueAllowableValues()
    {
        return [
            self::VALUE_SERVICE,
            self::VALUE_MATERIAL_COST,
            self::VALUE_OTHER_COST,
        ];
    }
