...
/**
 * InventoryReceiptUpdateDto Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InventoryReceiptUpdateDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InventoryReceiptUpdateDto';
    ...
    protected static $swaggerTypes = [
        'transfer_number' => 'object',
        'control_cost' => 'object',
        'receipt_lines' => '\Ekstralys\VismaNetApi\Model\InventoryReceiptLineUpdateDto[]',
     ...
     *
     * @param object $transfer_number The unique reference number of the receipt, which the system automatically assigns according to the numbering sequence selected for receipts on the Inventory Preferences IN.10.10.00) form.
     *
     * @return $this
     */
     ...
     * Sets control_cost
     *
     * @param object $control_cost The manually entered summary amount for all specified inventory receipt items.
     *
     * @return $this
     */
     ...
     * Gets receipt_lines
     *
     * @return \Ekstralys\VismaNetApi\Model\InventoryReceiptLineUpdateDto[]
     */
     ...
     * Sets receipt_lines
     *
     * @param \Ekstralys\VismaNetApi\Model\InventoryReceiptLineUpdateDto[] $receipt_lines The inventory issue lines
     *
     * @return $this
     */
