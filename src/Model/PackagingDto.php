 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PackagingDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PackagingDto';
     ...
     *
     * @param double $base_item_weight The weight of the <see cref=\"!:BaseUnit\">Base Unit</see> of the item.
     *
     * @return $this
     */
     ...
     * Sets weight_uom
     *
     * @param string $weight_uom The <see cref=\"!:INUnit\">Unit of Measure</see> used for the <see cref=\"P:Visma.net.ERP.Web.Api.Model.V1.IN.PackagingDto.BaseItemWeight\">Weight</see> of the item.
     *
     * @return $this
     */
     ...
     *
     * @param double $base_item_volume The volume of the <see cref=\"!:BaseUnit\">Base Unit</see> of the item.
     *
     * @return $this
     */
     ...
     * Sets volume_uom
     *
     * @param string $volume_uom The <see cref=\"!:INUnit\">Unit of Measure</see> used for the <see cref=\"P:Visma.net.ERP.Web.Api.Model.V1.IN.PackagingDto.BaseItemVolume\">Volume</see> of the item.
     *
     * @return $this
     */
