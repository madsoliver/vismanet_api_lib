 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InventoryReceiptLineDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InventoryReceiptLineDto';
     ...
     * Sets warehouse
     *
     * @param object $warehouse Mandatory field: Warehouse* &gt; The warehouse where the stock item is received.
     *
     * @return $this
     */
     ...
     * Sets unit_cost
     *
     * @param double $unit_cost Unit cost &gt; The cost of a unit of the received stock item.
     *
     * @return $this
     */
     ...
     * Sets ext_cost
     *
     * @param double $ext_cost Cost &gt; The extended cost of the received stock item. An extended cost is calculated automatically as the unit cost multiplied by the quantity (or amount) of item that was received.
     *
     * @return $this
     */
