 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EmployeeTimeCardQueryParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EmployeeTimeCardQueryParameters';
     ...
     * Sets week
     *
     * @param string $week Identifies the week number of the time card
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Identifies the type of the time card (Normal, Corrected, NormalCorrected)
     *
     * @return $this
     */
