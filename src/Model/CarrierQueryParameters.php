...
/**
 * CarrierQueryParameters Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CarrierQueryParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CarrierQueryParameters';
     ...
     * Sets number_to_read
     *
     * @param int $number_to_read Enter the number of records to read.
     *
     * @return $this
     */
     ...
     * Sets skip_records
     *
     * @param int $skip_records Enter the number of records to skip.
     *
     * @return $this
     */
