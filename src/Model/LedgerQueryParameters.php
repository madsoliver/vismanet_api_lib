...
/**
 * LedgerQueryParameters Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LedgerQueryParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LedgerQueryParameters';
     ...
     *
     * @param string $greater_than_value Excludes ledgers with value lower than entry
     *
     * @return $this
     */
     ...
     *
     * @param string $last_modified_date_time System retrieved information for state/condition. Valid date/time format is yyyy-MM-dd, yyyy-MM-dd HH:mm:ss or yyyy-MM-dd HH:mm:ss.FFF. FFF stands for milliseconds
     *
     * @return $this
     */
     ...
     *
     * @param string $last_modified_date_time_condition Values to be used for filtering lastModifiedDateTime value.  <remarks>Allowed values are \"&lt;\" \"&gt;\" \"&lt;=\" \"&gt;=\"</remarks>
     *
     * @return $this
     */
