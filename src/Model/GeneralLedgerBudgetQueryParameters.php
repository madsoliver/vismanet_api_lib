 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GeneralLedgerBudgetQueryParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GeneralLedgerBudgetQueryParameters';
     ...
     *
     * @param string $greater_than_value Filter by from date.
     *
     * @return $this
     */
     ...
     * Sets order_by
     *
     * @param string $order_by Order by Last modified date and time.
     *
     * @return $this
     */
     ...
     * Sets subaccount
     *
     * @param string $subaccount The Subaccount of the budget article.
     *
     * @return $this
     */
