 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InventoryIssueDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InventoryIssueDto';
    ...
    protected static $swaggerTypes = [
        ...
        'issue_lines' => '\Ekstralys\VismaNetApi\Model\InventoryIssueLineDto[]',
     ...
     * Sets total_amount
     *
     * @param double $total_amount The top part &gt; Total amount &gt; The total amount, calculated as a sum of amounts for all inventory issue operations included in this issue document.
     *
     * @return $this
     */
     ...
     * Sets control_amount
     *
     * @param double $control_amount The top part &gt; Control amount &gt; The manually entered summary amount for all specified inventory items. Control Amount is available only if the Validate Document Totals on Entry option is selected on the Inventory Preferences form. If the Control Amount and Total Amount values do not match, the system generates a warning message and the issue cannot be saved.
     *
     * @return $this
     */
     ...
     * Gets issue_lines
     *
     * @return \Ekstralys\VismaNetApi\Model\InventoryIssueLineDto[]
     */
     ...
     * Sets issue_lines
     *
     * @param \Ekstralys\VismaNetApi\Model\InventoryIssueLineDto[] $issue_lines Transaction details tab &gt;
     *
     * @return $this
     */
