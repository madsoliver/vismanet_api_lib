 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InventoryReceiptDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InventoryReceiptDto';
    ...
    protected static $swaggerTypes = [
        ...
        'receipt_lines' => '\Ekstralys\VismaNetApi\Model\InventoryReceiptLineDto[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['transfer_number'] = isset($data['transfer_number']) ? $data['transfer_number'] : null;
        $this->container['receipt_lines'] = isset($data['receipt_lines']) ? $data['receipt_lines'] : null;
     ...
     * Sets control_cost
     *
     * @param double $control_cost The total cost of the inventory items to be received. Control Cost is available only if the Validate Document Totals on Entry option is selected on the Inventory Preferences form. The user enters this value manually to confirm the total cost as calculated automatically for the document. If the Control Cost and Total Cost values do not match, the system generates a warning message and the document cannot be saved.
     *
     * @return $this
     */
     ...
     *
     * @param string $transfer_number The top part &gt; Transfer no. &gt; The transfer number for the receipt operation. (Enter this number only if the two-step transfer operation is performed.)
     *
     * @return $this
     */
     ...
     * Gets receipt_lines
     *
     * @return \Ekstralys\VismaNetApi\Model\InventoryReceiptLineDto[]
     */
     ...
     * Sets receipt_lines
     *
     * @param \Ekstralys\VismaNetApi\Model\InventoryReceiptLineDto[] $receipt_lines The inventory receipt lines
     *
     * @return $this
     */
