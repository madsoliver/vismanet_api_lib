...
/**
 * IntrastatDto Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IntrastatDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IntrastatDto';
     ...
     * Sets c_n8
     *
     * @param string $c_n8 Represents the 8 digit level Combine Nomenclature commodity code specific for the year  for which the creating / actualizations Intrastat declarations is drafted.
     *
     * @return $this
     */
     ...
     *
     * @param string $country_of_origin The country of origin of the commodity will be selected,  that country where the good has been produced or had the last substantial transformation.
     *
     * @return $this
     */
     ...
     *
     * @param string $supplementary_measure_unit The requirement for Supplementary Measure Units applies only to certain classes of goods(NC8 Positions)  that may be expressed from quantitative point of view in other measurement units but kilo also.
     *
     * @return $this
     */
