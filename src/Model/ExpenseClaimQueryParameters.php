...
/**
 * ExpenseClaimQueryParameters Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExpenseClaimQueryParameters implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExpenseClaimQueryParameters';
     ...
     * Sets date
     *
     * @param \DateTime $date The date of the document
     *
     * @return $this
     */
     ...
     * Sets customer
     *
     * @param string $customer The customer from the document
     *
     * @return $this
     */
     ...
     * Sets department_id
     *
     * @param string $department_id Identifies the department
     *
     * @return $this
     */
