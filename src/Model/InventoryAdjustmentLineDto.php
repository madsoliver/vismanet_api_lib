...
/**
 * InventoryAdjustmentLineDto Class Doc Comment
 *
 * @category Class
 * @package  Ekstralys\VismaNetApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InventoryAdjustmentLineDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InventoryAdjustmentLineDto';
     ...
     * Sets warehouse
     *
     * @param object $warehouse Mandatory field: Warehouse* &gt; The warehouse where the item is stocked.
     *
     * @return $this
     */
     ...
     * Sets unit_cost
     *
     * @param double $unit_cost Unit cost &gt; The cost of the unit used as base unit for the stock item.
     *
     * @return $this
     */
     ...
     * Sets ext_cost
     *
     * @param double $ext_cost Cost &gt; The cost of the item.
     *
     * @return $this
     */
     ...
     * Sets receipt_number
     *
     * @param string $receipt_number Receipt no. &gt; Reference number for the receipt for the stock item.
     *
     * @return $this
     */
