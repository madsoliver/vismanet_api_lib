...
/**
 * AllocationsUpdateDto Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AllocationsUpdateDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AllocationsUpdateDto';
     ...
     * Sets line_nbr
     *
     * @param object $line_nbr Line no. &gt; The line of the purchase order that contains the selected item.
     *
     * @return $this
     */
     ...
     *
     * @param object $lot_serial_number Lot/Serial no. &gt; The lot or serial number of the item.
     *
     * @return $this
     */
     ...
     * Sets quantity
     *
     * @param object $quantity Quantity &gt; The quantity of the stock item with the same lot number. It is 1 for items with serial numbers.
     *
     * @return $this
     */
     ...
     * Sets uom
     *
     * @param object $uom UoM &gt; The unit of measure for the specified quantity of the inventory item.
     *
     * @return $this
     */
     ...
     *
     * @param object $expiration_date Expiration date &gt; The expiration date of the specified quantity of the stock item.
     *
     * @return $this
     */
