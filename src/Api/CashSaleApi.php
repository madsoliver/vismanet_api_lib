...
class CashSaleApi
{
     ...
     */
    protected function cashSaleGetAllCashSalesRequest($document_type = null, $released = null, $dunning_level = null, $closed_financial_period = null, $dunning_letter_date_time = null, $dunning_letter_date_time_condition = null, $project = null, $expand_applications = null, $expand_dunning_information = null, $expand_attachments = null, $expand_tax_details = null, $expand_invoice_address = null, $financial_period = null, $document_due_date = null, $status = null, $number_to_read = null, $skip_records = null, $external_reference = null, $payment_reference = null, $customer_ref_number = null, $greater_than_value = null, $last_modified_date_time = null, $last_modified_date_time_condition = null, $created_date_time = null, $created_date_time_condition = null, $page_number = null, $page_size = null)
    {

        $resourcePath = '/controller/api/v1/cashsale';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \Ekstralys\VismaNetApi\Model\CashSaleDto
     */
    public function cashSaleGetBydocumentNumber($document_number)
    {
        list($response) = $this->cashSaleGetBydocumentNumberWithHttpInfo($document_number);
        return $response;
    }
     ...
     * @return array of \Ekstralys\VismaNetApi\Model\CashSaleDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function cashSaleGetBydocumentNumberWithHttpInfo($document_number)
    {
        $returnType = '\Ekstralys\VismaNetApi\Model\CashSaleDto';
        $request = $this->cashSaleGetBydocumentNumberRequest($document_number);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cashSaleGetBydocumentNumberAsync($document_number)
    {
        return $this->cashSaleGetBydocumentNumberAsyncWithHttpInfo($document_number)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cashSaleGetBydocumentNumberAsyncWithHttpInfo($document_number)
    {
        $returnType = '\Ekstralys\VismaNetApi\Model\CashSaleDto';
        $request = $this->cashSaleGetBydocumentNumberRequest($document_number);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function cashSaleGetBydocumentNumberRequest($document_number)
    {
        ...
        $resourcePath = '/controller/api/v1/cashsale/{documentNumber}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Create a Cash Sale
     *
     * @param  \Ekstralys\VismaNetApi\Model\CashSaleUpdateDto $cash_sale_update_dto Defines the data for the Cash Sale to create (required)
     *
     * @throws \Ekstralys\VismaNetApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function cashSalePost($cash_sale_update_dto)
    {
        list($response) = $this->cashSalePostWithHttpInfo($cash_sale_update_dto);
        return $response;
    }
     ...
     */
    public function cashSalePostWithHttpInfo($cash_sale_update_dto)
    {
        $returnType = 'object';
        $request = $this->cashSalePostRequest($cash_sale_update_dto);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cashSalePostAsync($cash_sale_update_dto)
    {
        return $this->cashSalePostAsyncWithHttpInfo($cash_sale_update_dto)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cashSalePostAsyncWithHttpInfo($cash_sale_update_dto)
    {
        $returnType = 'object';
        $request = $this->cashSalePostRequest($cash_sale_update_dto);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function cashSalePostRequest($cash_sale_update_dto)
    {
        ...
        if (isset($cash_sale_update_dto)) {
            $_tempBody = $cash_sale_update_dto;
        }
     ...
     * @param  \Ekstralys\VismaNetApi\Model\CashSaleUpdateDto $cash_sale_update_dto Defines the data for the Cash Sale to update (required)
     *
     * @throws \Ekstralys\VismaNetApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function cashSalePutBydocumentNumber($document_number, $cash_sale_update_dto)
    {
        list($response) = $this->cashSalePutBydocumentNumberWithHttpInfo($document_number, $cash_sale_update_dto);
        return $response;
    }
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function cashSalePutBydocumentNumberWithHttpInfo($document_number, $cash_sale_update_dto)
    {
        $returnType = 'object';
        $request = $this->cashSalePutBydocumentNumberRequest($document_number, $cash_sale_update_dto);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cashSalePutBydocumentNumberAsync($document_number, $cash_sale_update_dto)
    {
        return $this->cashSalePutBydocumentNumberAsyncWithHttpInfo($document_number, $cash_sale_update_dto)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cashSalePutBydocumentNumberAsyncWithHttpInfo($document_number, $cash_sale_update_dto)
    {
        $returnType = 'object';
        $request = $this->cashSalePutBydocumentNumberRequest($document_number, $cash_sale_update_dto);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function cashSalePutBydocumentNumberRequest($document_number, $cash_sale_update_dto)
    {
        // verify the required parameter 'document_number' is set
        if ($document_number === null || (is_array($document_number) && count($document_number) === 0)) {
            throw new \InvalidArgumentException(
